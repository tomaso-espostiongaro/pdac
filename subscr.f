...
!
      ...
      ijtr = myinds(ip1_jp1_kp0_, ij)
      ijtl = myinds(im1_jp1_kp0_, ij)
      ijbl = myinds(im1_jm1_kp0_, ij)
      ijbr = myinds(ip1_jm1_kp0_, ij)
      ijrr = myinds(ip2_jp0_kp0_, ij)
      ijtt = myinds(ip0_jp2_kp0_, ij) 
      ijll = myinds(im2_jp0_kp0_, ij)
      ijbb = myinds(ip0_jm2_kp0_, ij) 
!
      END SUBROUTINE
!-----------------------------------------------------------------------
