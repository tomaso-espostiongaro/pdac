...
! ... vent center is located where the mesh is more refined.
...
!
      ...
      DO j = 1, vdem%ny
        DO i = 1, vdem%nx
          IF( (xtop(i)-xvent)**2 + (ytop(j)-yvent)**2 <= base_radius**2 ) &
            ztop2d(i,j) = zb(kv)
        END DO
      END DO
!
! ... Reset the cell flags at the base of the crater and the 'dist' array
!
      DO j = 1, ny
        DO i = 1, nx
...
!
      ...
      vcell(:)%fact = 1.D0
!
! ... Set the threshold to include a cell
! ... into the vent
!
