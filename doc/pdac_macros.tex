...
\newcommand{\PDACDATE} {May 2008}
\newcommand{\RMAUTHORS} {
 T.~Esposti Ongaro, A.~Neri, C.~Cavazzoni, G.~Erbacci and G.~Macedonio }
\newcommand{\UGAUTHORS} {
T.~Esposti Ongaro, C.~Cavazzoni and A.~Neri }
\newcommand{\PASTPDACVERSION} {2.0}
\newcommand{\PDACVERSION} {3.0}
\newcommand{\RELEASEVERSION} {3.1}
...
to set the appropriate input parameters for the simulation of volcanic
eruptions, how to read the results and how the program is run either on
uniprocessor or parallel machines.}
