...
\item
\PDACCONFWDEF{tau}{transient v.c.}{double real}{0.0}
...
\item
\PDACCONFWDEF{flim}{Multiphase limit}{very small real value}{$10^{-8}$}
{It is related to minimum particle concentration for which multiphase flow
...
\item
\PDACCONFWDEF{deltaz}{Height above the ground for mapping}{any real $>$ 0.0}{20.0}
...
\item
\PDACCONFWDEF{imap}{Flag for mapping}{0/1}{0}
...
\item
\PDACCONFWDEF{iali}{Flag for anti-aliasing}{0/1}{0}
