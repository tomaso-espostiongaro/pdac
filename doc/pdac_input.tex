...
\item
\PDACCONFWDEF{formatted\_output}{flag for OUTPUT format}{{\tt .TRUE./.FALSE.}}{{\tt T}}
...
\item
\PDACCONFWDEF{nsolid}{number of solid phases}{up to 10}
{Maximum number can be increased by modifying the max\_nsolid parameter
in the ``dimensions'' module.}{2}

\item
\PDACCONFWDEF{diameter}{effective diameter particles (in microns)}{real}
{The model works well for particle diameters smaller than few millimeters}{100 microns}

\item
\PDACCONFWDEF{density}{microscopic particle density}{real}
{Depends on materials and porosity}{2700. Kg / m$^3$}

\item
\PDACCONFWDEF{sphericity}{particle sphericity}{0.5 to 1.0}
{Partially accounts for particle shapes}{1.0}

\item
\PDACCONFWDEF{viscosity}{Empirical viscosity coefficient}{0.5 to 2.0}
{Largest values apply to coarse particles}{0.5 [Pa s]}

\item
\PDACCONFWDEF{specific\_heat}{solid specific heat}{ral}
