...
\item \FIL{<dim> $N$ </dim>} \\
      ...
      {\it type} the type of the dimension (ex. \FIL{<dim type="integer">})
      {\it size} the size of the dimension (ex. \FIL{<dim size="1">})

\item \FIL{<cfile> filename </cfile>} \\

\item \FIL{<file> filename </file>} \\

\item \FIL{<attributes> </attributes>} \\

\item \FIL{<profile> </profile>} \\

\item \FIL{<scalar> </scalar>} \\

\item \FIL{<staggered> </staggered>} \\

\item \FIL{<frames> </frames>} \\

\item \FIL{<timestep> </timestep>} \\
